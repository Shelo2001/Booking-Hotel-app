...
const stripe = require('stripe')('sk_test_51KShu0Cb4jB24EPJkhW1k440WHN4y99ZZmKrTILZQ5bMASWsM96swMQophEsMkvMAWTOpc6KI73EkrWGppBWgBPP00sckd9UVB')
...
router.post('/bookroom', async (req, res) => {
  ...
  try {
    ...
    res.send('Payment ended Successfully, Your Room is Booked')
  } catch (error) {
